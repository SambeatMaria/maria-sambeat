{
    ...
    function controlProyecto (sumar) {
      if (sumar && proyecto === 4) {
        proyecto = 0;
      }
    ...
    class Slide {
        ...
        animateElementsOut(contentItem) {
            return new Promise((resolve, reject) => {
                ...
                this.elemsTimeline = new TimelineMax({onComplete: function(){
                  //console.log("hola",urlsProyectos["proyecto" + proyecto]);
                  location.href = urlsProyectos["proyecto" + proyecto];
                }})
