...
!(function(r) {
  ...
  var o = r.GreenSockGlobals || r,
    ...
    q = document,
    t = void 0 !== r ? r : q.defaultView || { getComputedStyle: function() {} },
    z = function(e) {
        ...
        (i = i || z(e))
          ? (r =
              ...
              i.length
                ? e
                : i[t])
          : e.currentStyle && (r = (i = e.currentStyle)[t]),
        n ? r : parseInt(r, 10) || 0
      );
    },
    d = function(e) {
    ...
    h =
      ...
      (q.all && !q.addEventListener ? "*display:inline;*zoom:1;'" : "'"),
    p = function(e, t) {
      var i = -1 !== (e = e || "").indexOf("++"),
        n = 1;
      return (
    ...
    g = function(e, t, i, n, r, o, s) {
          ...
          ((f = (h = p[l]).parentNode === e) || j || (R && !k)) &&
            ...
            E &&
              (((h._isSplit && f) ||
                ...
                (u.push(h), (h._x -= y), P(h, e, V) && (h._wordEnd = !0)),
              "BR" === h.nodeName &&
              ...
              !k && R
                ? h._isSplit
                  ...
                  ? ((h._parent = h.parentNode),
                    ...
                    d--)
                  : f ||
                    ((m = !h.nextSibling && P(h.parentNode, e, V)),
                    h.parentNode._parent && h.parentNode._parent.appendChild(h),
                    m && h.parentNode.appendChild(q.createTextNode(" ")),
                ...
                : R &&
                  !h._isSplit &&
                  ("span" === W && (h.style.display = "inline"), L.push(h)))
            : E || j
      ...
      if (E) {
        ...
        for (g = " " === V && (!j || (!k && !R)), l = 0; l < E.length; l++) {
          for (
            u = E[l],
              (C = q.createElement(W)).style.cssText =
            ...
            "BR" !== u[a].nodeName &&
              ((h = u[a]),
              C.appendChild(h),
              g && h._wordEnd && C.appendChild(q.createTextNode(" ")),
              j &&
                (0 === a &&
                  ((C.style.top = h._y + "px"), (C.style.left = y + m + "px")),
                (h.style.top = "0px"),
                m && (h.style.left = h._x - m + "px")));
          0 === d
            ? (C.innerHTML = "&nbsp;")
            : k || R || (Q(C), F(C, String.fromCharCode(160), " ")),
            j && ((C.style.width = S), (C.style.height = h._h + "px")),
            e.appendChild(C);
        }
        e.style.cssText = c;
      }
    ...
    c = function(e, t, i, n) {
      ...
      if (3 !== e.nodeType || 1 < l) {
        for (t.absolute = !1, r = 0; r < l; r++)
          (3 !== (o = s[r]).nodeType || /\S+/.test(o.nodeValue)) &&
            (a &&
              3 !== o.nodeType &&
              "inline" === D(o, "display", null, !0) &&
      ...
      !(function(e, t, i, n) {
        var r,
          ...
          f,
          u,
          g = t.tag ? t.tag : t.span ? "span" : "div",
          c =
            -1 !== (t.type || t.split || "chars,words,lines").indexOf("chars"),
        ...
        for (
          _.insertBefore(v, e),
            ...
            _.removeChild(e),
            h = -1 !== (r = T((e = v))).indexOf("<"),
            !1 !== t.reduceWhiteSpace && (r = r.replace(A, " ").replace(w, "")),
            h && (r = r.split("<").join("{{LT}}")),
            a = r.length,
            o = (" " === r.charAt(0) ? m : "") + i(),
            s = 0;
          ...
          if (((d = r.charAt(s)), b && (u = b(r.substr(s), t.specialChars))))
            (d = r.substr(s, u || 1)),
              (o += c && " " !== d ? n() + d + "</" + g + ">" : d),
              (s += u - 1);
          else if (d === S && r.charAt(s - 1) !== S && s) {
            for (o += y ? x : "", y = !1; r.charAt(s + 1) === S; )
              (o += m), s++;
            s === a - 1
              ? (o += m)
              : ")" !== r.charAt(s + 1) && ((o += m + i()), (y = !0));
          } else
            "{" === d && "{{LT}}" === r.substr(s, 6)
              ? ((o += c ? n() + "{{LT}}</" + g + ">" : "{{LT}}"), (s += 5))
              : (55296 <= d.charCodeAt(0) && d.charCodeAt(0) <= 56319) ||
                (65024 <= r.charCodeAt(s + 1) && r.charCodeAt(s + 1) <= 65039)
              ? ((p = O(r.substr(s, 2))),
                (f = O(r.substr(s + 2, 2))),
                (l =
                  (L <= p && p <= B && L <= f && f <= B) ||
  ...
  (C.split = function(e) {
    ...
    for (
      ...
      (n = this.elements[r]),
        ...
        (i = n.clientWidth),
        c(n, e, s, l),
        g(n, e, this.chars, this.words, this.lines, i, t);
    return (
      this.chars.reverse(),
      this.words.reverse(),
      this.lines.reverse(),
